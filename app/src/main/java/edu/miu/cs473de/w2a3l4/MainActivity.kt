package edu.miu.cs473de.w2a3l4
...
import edu.miu.cs473de.w2a3l4.models.AndroidVersionModel
...
//        if (list.containsKey(item.ver)){
//            list[item.ver] = item
//            findViewById<TextView>(item.code.toInt()).text=item.code
            //Edit the Text View
//        }else{
            list[item.ver] = item
            initialRowView(item)
